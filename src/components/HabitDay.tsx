...
export function HabitDay({defaultCompleted = 0, amount = 0, date}: HabitDayProgress) {
  ...
  return (
    <Popover.Root>
      <Popover.Trigger className={clsx("w-10 h-10 rounded-lg bg-zinc-900 border-2 border-zinc-800 transition-colors", {
